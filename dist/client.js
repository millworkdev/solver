...
import { VerifierConnection } from "./verifierConnection.js";
/**
...
export class Solver {
    ...
    constructor(options) {
        ...
        this.verifierConnection = new VerifierConnection(http);
        ...
        this.tenantTemplates = new TenantTemplatesResource(http);
    }
}
