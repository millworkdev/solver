...
- the closed export contains exactly 84 JavaScript and declaration files plus
  14 maintained kit assets, including `dist/cli.js` and every runtime module
  it imports;
...
- the version advanced to `0.1.17`; immutable `0.1.0` through `0.1.3`, `0.1.5`,
  `0.1.6` through `0.1.16` are never republished or altered, and `0.1.4` remains unused
